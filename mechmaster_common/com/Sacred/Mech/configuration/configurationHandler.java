...
public class configurationHandler {
	...
	public static void init(File file){
		...
		try{
			...
			BlockIds.NETHER_TESSERACT_ORE_ID = config.getBlock(Strings.NETHER_TESSERACT_ORE_NAME, BlockIds.NETHER_TESSERACT_ORE_ID_DEFAULT).getInt(BlockIds.NETHER_TESSERACT_ORE_ID_DEFAULT);
			BlockIds.END_TESSERACT_ORE_ID = config.getBlock(Strings.END_TESSERACT_ORE_NAME, BlockIds.END_TESSERACT_ORE_ID_DEFAULT).getInt(BlockIds.END_TESSERACT_ORE_ID_DEFAULT);
			//Items
